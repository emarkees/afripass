...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment_counter: async (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = await this._increment_counter_0(context,
                                                         partialProofData,
                                                         step_0);
  ...
  async _increment_counter_0(context, partialProofData, step_0) {
    step_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
...
export const expectedVk = {
  'increment_counter': 'cad87a70cb589b7228770a31939dffb0439a40811de7e39bbaee09c8b5f34fcb',
};
